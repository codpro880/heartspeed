/**
THIS CARD WAS AUTOGENERATED BY ../python/heartspeed/cards/generate_card_classes.py.
DO NOT EDIT BY HAND.
**/
#include <string>
...
BgBaseCard BgCardFactory::get_card(std::string name) {
	if (name == "Nathrezim Overseer") {
		...
		return BgBaseCard(4, "NEUTRAL", 8, 4, "BGS_018", "Goldrinn, the Great Wolf", "['DEATHRATTLE']", "BEAST", "LEGENDARY", 5, "<b>Deathrattle:</b> Give your Beasts +4/+4.", "MINION");
	}
		...
		return BgBaseCard(-1, "NEUTRAL", 0, -1, "TB_BaconShop_HP_048", "Battle Brand", "['TRIGGER_VISUAL']", "", "", -1, "[x]<b>Passive Hero Power</b> After you play a <b>Battlecry</b> minion, give a random    friendly minion +1/+1.", "HERO_POWER");
	}
		...
		return BgBaseCard(-1, "NEUTRAL", 0, -1, "TB_BaconShop_HP_065", "Demon Hunter Training", "", "", "", -1, "[x]<b>Passive Hero Power</b> After you <b>Refresh</b> 7 times, Bob always has 7 minions. <i>(7 left!)</i>", "HERO_POWER");
	}
		...
		return BgBaseCard(-1, "NEUTRAL", 0, -1, "TB_BaconShop_HP_075", "Trash for Treasure", "", "", "", -1, "[x]<b>Hero Power</b> Remove a friendly minion.  <b>Discover</b> one from a Tavern Tier lower.", "HERO_POWER");
	}
	...
	else if (name == "Mecharoo") {
		return BgBaseCard(2, "NEUTRAL", 1, 2, "TB_BaconUps_002", "Mecharoo", "['DEATHRATTLE']", "MECHANICAL", "COMMON", 1, "<b>Deathrattle:</b> Summon a 2/2 Jo-E Bot.", "MINION");
	}
	else if (name == "Jo-E Bot") {
		return BgBaseCard(2, "NEUTRAL", 1, 2, "TB_BaconUps_002t", "Jo-E Bot", "", "MECHANICAL", "", 1, "", "MINION");
	}
	else if (name == "Murloc Tidehunter") {
		return BgBaseCard(4, "NEUTRAL", 2, 2, "TB_BaconUps_003", "Murloc Tidehunter", "['BATTLECRY']", "MURLOC", "FREE", 1, "<b>Battlecry:</b> Summon a 2/2 Murloc Scout.", "MINION");
	}
	else if (name == "Murloc Scout") {
		return BgBaseCard(2, "NEUTRAL", 1, 2, "TB_BaconUps_003t", "Murloc Scout", "", "MURLOC", "COMMON", 1, "", "MINION");
	}
	else if (name == "Kindly Grandmother") {
		return BgBaseCard(2, "HUNTER", 2, 2, "TB_BaconUps_004", "Kindly Grandmother", "['DEATHRATTLE']", "BEAST", "COMMON", 2, "<b>Deathrattle:</b> Summon a 6/4 Big Bad Wolf.", "MINION");
	}
	else if (name == "Big Bad Wolf") {
		return BgBaseCard(6, "HUNTER", 2, 4, "TB_BaconUps_004t", "Big Bad Wolf", "", "BEAST", "", 1, "", "MINION");
	}
	else if (name == "Harvest Golem") {
		return BgBaseCard(4, "NEUTRAL", 3, 6, "TB_BaconUps_006", "Harvest Golem", "['DEATHRATTLE']", "MECHANICAL", "COMMON", 2, "<b>Deathrattle:</b> Summon a 4/2 Damaged Golem.", "MINION");
	}
	else if (name == "Damaged Golem") {
		return BgBaseCard(4, "NEUTRAL", 1, 2, "TB_BaconUps_006t", "Damaged Golem", "", "MECHANICAL", "", 1, "", "MINION");
	}
	else if (name == "Murloc Warleader") {
		return BgBaseCard(6, "NEUTRAL", 3, 6, "TB_BaconUps_008", "Murloc Warleader", "['AURA']", "MURLOC", "EPIC", 2, "Your other Murlocs have +4 Attack.", "MINION");
	}
	else if (name == "Mrgglaargl!") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_008e", "Mrgglaargl!", "", "", "", -1, "+4 Attack from Murloc Warleader.", "ENCHANTMENT");
	}
	else if (name == "Defender of Argus") {
		return BgBaseCard(4, "NEUTRAL", 4, 6, "TB_BaconUps_009", "Defender of Argus", "['BATTLECRY']", "", "RARE", 4, "<b>Battlecry:</b> Give adjacent minions +2/+2 and <b>Taunt</b>.", "MINION");
	}
	else if (name == "Hand of Argus") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_009e", "Hand of Argus", "", "", "", -1, "+2/+2 and <b>Taunt</b>.", "ENCHANTMENT");
	}
	else if (name == "Murloc Tidecaller") {
		return BgBaseCard(2, "NEUTRAL", 1, 4, "TB_BaconUps_011", "Murloc Tidecaller", "['TRIGGER_VISUAL']", "MURLOC", "RARE", 1, "Whenever you summon a Murloc, gain +2 Attack.", "MINION");
	}
	else if (name == "Blarghghl") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_011e", "Blarghghl", "", "", "", -1, "Increased Attack.", "ENCHANTMENT");
	}
	else if (name == "Selfless Hero") {
		return BgBaseCard(4, "PALADIN", 1, 2, "TB_BaconUps_014", "Selfless Hero", "['DEATHRATTLE']", "", "RARE", 1, "<b>Deathrattle:</b> Give 2 random friendly minions <b>Divine Shield</b>.", "MINION");
	}
	else if (name == "Mounted Raptor") {
		return BgBaseCard(6, "DRUID", 3, 4, "TB_BaconUps_019", "Mounted Raptor", "['DEATHRATTLE']", "BEAST", "COMMON", 2, "<b>Deathrattle:</b> Summon two random 1-Cost minions.", "MINION");
	}
	else if (name == "Spawn of N'Zoth") {
		return BgBaseCard(4, "NEUTRAL", 3, 4, "TB_BaconUps_025", "Spawn of N'Zoth", "['DEATHRATTLE']", "", "COMMON", 2, "<b>Deathrattle:</b> Give your minions +2/+2.", "MINION");
	}
	else if (name == "Slimed") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_025e", "Slimed", "", "", "", -1, "+2/+2.", "ENCHANTMENT");
	}
	else if (name == "Infested Wolf") {
		return BgBaseCard(6, "HUNTER", 4, 6, "TB_BaconUps_026", "Infested Wolf", "['DEATHRATTLE']", "BEAST", "RARE", 3, "<b>Deathrattle:</b> Summon two 2/2 Spiders.", "MINION");
	}
	else if (name == "Spider") {
		return BgBaseCard(2, "HUNTER", 1, 2, "TB_BaconUps_026t", "Spider", "", "BEAST", "", 1, "", "MINION");
	}
	else if (name == "Rat Pack") {
		return BgBaseCard(4, "HUNTER", 3, 4, "TB_BaconUps_027", "Rat Pack", "['DEATHRATTLE']", "BEAST", "EPIC", 2, "[x]<b>Deathrattle:</b> Summon a number of 2/2 Rats equal  to this minion's Attack.", "MINION");
	}
	else if (name == "Rat") {
		return BgBaseCard(2, "HUNTER", 1, 2, "TB_BaconUps_027t", "Rat", "", "BEAST", "", 1, "", "MINION");
	}
	else if (name == "Kaboom Bot") {
		return BgBaseCard(4, "NEUTRAL", 3, 4, "TB_BaconUps_028", "Kaboom Bot", "['DEATHRATTLE']", "MECHANICAL", "COMMON", 2, "<b>Deathrattle:</b> Deal 4 damage to a random enemy minion twice.", "MINION");
	}
	else if (name == "Imp Gang Boss") {
		return BgBaseCard(4, "WARLOCK", 3, 8, "TB_BaconUps_030", "Imp Gang Boss", "['TRIGGER_VISUAL']", "DEMON", "COMMON", 3, "Whenever this minion takes damage, summon a 2/2 Imp.", "MINION");
	}
	else if (name == "Imp") {
		return BgBaseCard(2, "WARLOCK", 1, 2, "TB_BaconUps_030t", "Imp", "", "DEMON", "", 1, "", "MINION");
	}
	else if (name == "Tortollan Shellraiser") {
		return BgBaseCard(4, "PRIEST", 4, 12, "TB_BaconUps_031", "Tortollan Shellraiser", "['DEATHRATTLE', 'TAUNT']", "", "COMMON", 3, "[x]<b>Taunt</b> <b>Deathrattle:</b> Give a random  friendly minion +2/+2.", "MINION");
	}
	else if (name == "Shellshield") {
		return BgBaseCard(-1, "PRIEST", -1, -1, "TB_BaconUps_031e", "Shellshield", "", "", "", -1, "+2/+2.", "ENCHANTMENT");
	}
	else if (name == "Replicating Menace") {
		return BgBaseCard(6, "NEUTRAL", 4, 2, "TB_BaconUps_032", "Replicating Menace", "['DEATHRATTLE', 'MODULAR']", "MECHANICAL", "RARE", 3, "<b>Magnetic</b> <b>Deathrattle:</b> Summon three 2/2 Microbots.", "MINION");
	}
	else if (name == "Replicating Menace") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_032e", "Replicating Menace", "['MODULAR']", "", "", -1, "<b>Deathrattle:</b> Summon three 2/2 Microbots.", "ENCHANTMENT");
	}
	else if (name == "Microbot") {
		return BgBaseCard(2, "NEUTRAL", 1, 2, "TB_BaconUps_032t", "Microbot", "", "MECHANICAL", "", 1, "", "MINION");
	}
	else if (name == "Festeroot Hulk") {
		return BgBaseCard(4, "WARRIOR", 5, 14, "TB_BaconUps_033", "Festeroot Hulk", "['TRIGGER_VISUAL']", "", "RARE", 4, "After a friendly minion attacks, gain +2 Attack.", "MINION");
	}
	else if (name == "Grown") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_033e", "Grown", "", "", "", -1, "Increased Attack.", "ENCHANTMENT");
	}
	else if (name == "Khadgar") {
		return BgBaseCard(4, "MAGE", 2, 4, "TB_BaconUps_034", "Khadgar", "['TRIGGER_VISUAL']", "", "LEGENDARY", 3, "Your cards that summon minions summon three times as many.", "MINION");
	}
	else if (name == "Piloted Shredder") {
		return BgBaseCard(8, "NEUTRAL", 4, 6, "TB_BaconUps_035", "Piloted Shredder", "['DEATHRATTLE']", "MECHANICAL", "COMMON", 3, "<b>Deathrattle:</b> Summon two random 2-Cost minions.", "MINION");
	}
	else if (name == "Old Murk-Eye") {
		return BgBaseCard(4, "NEUTRAL", 4, 8, "TB_BaconUps_036", "Old Murk-Eye", "['CHARGE']", "MURLOC", "LEGENDARY", 2, "<b>Charge</b>. Has +2 Attack for each other Murloc on the battlefield.", "MINION");
	}
	else if (name == "Crowd Favorite") {
		return BgBaseCard(8, "NEUTRAL", 4, 8, "TB_BaconUps_037", "Crowd Favorite", "['TRIGGER_VISUAL']", "", "EPIC", 3, "Whenever you play a card with <b>Battlecry</b>, gain +2/+2.", "MINION");
	}
	else if (name == "Huge Ego") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_037e", "Huge Ego", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Phalanx Commander") {
		return BgBaseCard(8, "NEUTRAL", 5, 10, "TB_BaconUps_038", "Phalanx Commander", "['AURA']", "", "COMMON", 3, "Your <b>Taunt</b> minions have +4 Attack.", "MINION");
	}
	else if (name == "Commanded") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_038e", "Commanded", "", "", "", -1, "Phalanx Commander is granting this +4 Attack.", "ENCHANTMENT");
	}
	else if (name == "Mechano-Egg") {
		return BgBaseCard(0, "PALADIN", 5, 10, "TB_BaconUps_039", "Mechano-Egg", "['DEATHRATTLE']", "MECHANICAL", "COMMON", 4, "<b>Deathrattle:</b> Summon a 16/16 Robosaur.", "MINION");
	}
	else if (name == "Robosaur") {
		return BgBaseCard(16, "PALADIN", 8, 16, "TB_BaconUps_039t", "Robosaur", "", "MECHANICAL", "", 1, "", "MINION");
	}
	else if (name == "Safeguard") {
		return BgBaseCard(8, "NEUTRAL", 6, 10, "TB_BaconUps_040", "Safeguard", "['DEATHRATTLE', 'TAUNT']", "MECHANICAL", "COMMON", 4, "[x]<b>Taunt</b> <b>Deathrattle:</b> Summon a 0/10 Vault Safe with <b>Taunt</b>.", "MINION");
	}
	else if (name == "Vault Safe") {
		return BgBaseCard(0, "NEUTRAL", 2, 10, "TB_BaconUps_040t", "Vault Safe", "['TAUNT']", "MECHANICAL", "", 1, "<b>Taunt</b>", "MINION");
	}
	else if (name == "Security Rover") {
		return BgBaseCard(4, "WARRIOR", 6, 12, "TB_BaconUps_041", "Security Rover", "['TRIGGER_VISUAL']", "MECHANICAL", "RARE", 4, "[x]Whenever this minion takes damage, summon a 4/6 Mech with <b>Taunt</b>.", "MINION");
	}
	else if (name == "Guard Bot") {
		return BgBaseCard(4, "WARRIOR", 2, 6, "TB_BaconUps_041t", "Guard Bot", "['TAUNT']", "MECHANICAL", "", 1, "<b>Taunt</b>", "MINION");
	}
	else if (name == "The Beast") {
		return BgBaseCard(18, "NEUTRAL", 6, 14, "TB_BaconUps_042", "The Beast", "['DEATHRATTLE']", "BEAST", "LEGENDARY", 3, "<b>Deathrattle:</b> Summon a 3/3 Finkle Einhorn for your opponent.", "MINION");
	}
	else if (name == "Scavenging Hyena") {
		return BgBaseCard(4, "HUNTER", 2, 4, "TB_BaconUps_043", "Scavenging Hyena", "['TRIGGER_VISUAL']", "BEAST", "COMMON", 1, "Whenever a friendly Beast dies, gain +4/+2.", "MINION");
	}
	else if (name == "Well Fed") {
		return BgBaseCard(-1, "HUNTER", -1, -1, "TB_BaconUps_043e", "Well Fed", "", "", "", -1, "Increased Attack and Health.", "ENCHANTMENT");
	}
	else if (name == "Iron Sensei") {
		return BgBaseCard(4, "ROGUE", 3, 4, "TB_BaconUps_044", "Iron Sensei", "['TRIGGER_VISUAL']", "MECHANICAL", "RARE", 4, "At the end of your turn, give another friendly Mech +4/+4.", "MINION");
	}
	else if (name == "Ironed Out") {
		return BgBaseCard(-1, "ROGUE", -1, -1, "TB_BaconUps_044e", "Ironed Out", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Brann Bronzebeard") {
		return BgBaseCard(4, "NEUTRAL", 3, 8, "TB_BaconUps_045", "Brann Bronzebeard", "['AURA']", "", "LEGENDARY", 5, "Your <b>Battlecries</b> trigger three times.", "MINION");
	}
	else if (name == "Bronzebeard Battlecry") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_045e", "Bronzebeard Battlecry", "", "", "", -1, "Your <b>Battlecries</b> trigger three times.", "ENCHANTMENT");
	}
	else if (name == "Junkbot") {
		return BgBaseCard(2, "NEUTRAL", 5, 10, "TB_BaconUps_046", "Junkbot", "['TRIGGER_VISUAL']", "MECHANICAL", "EPIC", 5, "Whenever a friendly Mech dies, gain +4/+4.", "MINION");
	}
	else if (name == "Junked Up") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_046e", "Junked Up", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Bolvar, Fireblood") {
		return BgBaseCard(2, "PALADIN", 5, 14, "TB_BaconUps_047", "Bolvar, Fireblood", "['DIVINE_SHIELD', 'TRIGGER_VISUAL']", "", "LEGENDARY", 4, "<b>Divine Shield</b> After a friendly minion loses <b>Divine Shield</b>, gain +4 Attack.", "MINION");
	}
	else if (name == "Fading Light") {
		return BgBaseCard(-1, "PALADIN", -1, -1, "TB_BaconUps_047e", "Fading Light", "", "", "", -1, "Increased Attack.", "ENCHANTMENT");
	}
	else if (name == "Savannah Highmane") {
		return BgBaseCard(12, "HUNTER", 6, 10, "TB_BaconUps_049", "Savannah Highmane", "['DEATHRATTLE']", "BEAST", "RARE", 4, "<b>Deathrattle:</b> Summon two 4/4 Hyenas.", "MINION");
	}
	else if (name == "Hyena") {
		return BgBaseCard(4, "HUNTER", 2, 4, "TB_BaconUps_049t", "Hyena", "", "BEAST", "", 1, "", "MINION");
	}
	else if (name == "Piloted Sky Golem") {
		return BgBaseCard(12, "NEUTRAL", 6, 8, "TB_BaconUps_050", "Piloted Sky Golem", "['DEATHRATTLE']", "MECHANICAL", "EPIC", 4, "<b>Deathrattle:</b> Summon two random 4-Cost minions.", "MINION");
	}
	else if (name == "Ironhide Direhorn") {
		return BgBaseCard(14, "DRUID", 7, 14, "TB_BaconUps_051", "Ironhide Direhorn", "['OVERKILL']", "BEAST", "COMMON", 5, "<b>Overkill:</b> Summon a 10/10 Ironhide Runt.", "MINION");
	}
	else if (name == "Ironhide Runt") {
		return BgBaseCard(10, "DRUID", 5, 10, "TB_BaconUps_051t", "Ironhide Runt", "", "BEAST", "", 1, "", "MINION");
	}
	else if (name == "Sated Threshadon") {
		return BgBaseCard(10, "NEUTRAL", 7, 14, "TB_BaconUps_052", "Sated Threshadon", "['DEATHRATTLE']", "BEAST", "COMMON", 5, "<b>Deathrattle:</b> Summon three 2/2 Murlocs.", "MINION");
	}
	else if (name == "Primalfin") {
		return BgBaseCard(2, "NEUTRAL", 1, 2, "TB_BaconUps_052t", "Primalfin", "", "MURLOC", "", 1, "", "MINION");
	}
	else if (name == "Siegebreaker") {
		return BgBaseCard(10, "WARLOCK", 7, 16, "TB_BaconUps_053", "Siegebreaker", "['AURA', 'TAUNT']", "DEMON", "RARE", 4, "<b>Taunt</b> Your other Demons have +2 Attack.", "MINION");
	}
	else if (name == "Siegebreaking") {
		return BgBaseCard(-1, "WARLOCK", -1, -1, "TB_BaconUps_053e", "Siegebreaking", "", "", "", -1, "Siegebreaker is granting this minion +2 Attack.", "ENCHANTMENT");
	}
	else if (name == "Baron Rivendare") {
		return BgBaseCard(2, "NEUTRAL", 4, 14, "TB_BaconUps_055", "Baron Rivendare", "['AURA']", "", "LEGENDARY", 5, "Your minions trigger their <b>Deathrattles</b> three times.", "MINION");
	}
		...
		return BgBaseCard(14, "PRIEST", 6, 14, "TB_BaconUps_057", "Ghastcoiler", "['DEATHRATTLE']", "BEAST", "", 6, "<b>Deathrattle:</b> Summon 4 random <b>Deathrattle</b> minions.", "MINION");
	}
	else if (name == "The Boogeymonster") {
		return BgBaseCard(12, "NEUTRAL", 8, 14, "TB_BaconUps_058", "The Boogeymonster", "['TRIGGER_VISUAL']", "", "LEGENDARY", 4, "Whenever this attacks and kills a minion, gain +4/+4.", "MINION");
	}
	else if (name == "Tasty!") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_058e", "Tasty!", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Voidlord") {
		return BgBaseCard(6, "WARLOCK", 9, 18, "TB_BaconUps_059", "Voidlord", "['DEATHRATTLE', 'TAUNT']", "DEMON", "EPIC", 5, "[x]<b>Taunt</b>  <b>Deathrattle:</b> Summon three 2/6 Demons with <b>Taunt</b>.", "MINION");
	}
	else if (name == "Voidwalker") {
		return BgBaseCard(2, "WARLOCK", 1, 6, "TB_BaconUps_059t", "Voidwalker", "['TAUNT']", "DEMON", "FREE", 1, "<b>Taunt</b>", "MINION");
	}
	else if (name == "Mal'Ganis") {
		return BgBaseCard(18, "WARLOCK", 9, 14, "TB_BaconUps_060", "Mal'Ganis", "['AURA']", "DEMON", "LEGENDARY", 5, "Your other Demons have +4/+4. Your hero is <b>Immune</b>.", "MINION");
	}
	else if (name == "Grasp of Mal'Ganis") {
		return BgBaseCard(-1, "WARLOCK", -1, -1, "TB_BaconUps_060e", "Grasp of Mal'Ganis", "", "", "", -1, "Mal'Ganis is granting +4/+4.", "ENCHANTMENT");
	}
	else if (name == "Rockpool Hunter") {
		return BgBaseCard(4, "NEUTRAL", 2, 6, "TB_BaconUps_061", "Rockpool Hunter", "['BATTLECRY']", "MURLOC", "COMMON", 1, "<b>Battlecry:</b> Give a friendly Murloc +2/+2.", "MINION");
	}
	else if (name == "Trained") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_061e", "Trained", "", "", "", -1, "+2/+2", "ENCHANTMENT");
	}
	else if (name == "Nathrezim Overseer") {
		return BgBaseCard(4, "NEUTRAL", 3, 6, "TB_BaconUps_062", "Nathrezim Overseer", "['BATTLECRY']", "DEMON", "RARE", 2, "<b>Battlecry:</b> Give a friendly Demon +4/+4.", "MINION");
	}
	else if (name == "Impish") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_062e", "Impish", "", "", "", -1, "+4/+4.", "ENCHANTMENT");
	}
	else if (name == "Zoobot") {
		return BgBaseCard(6, "NEUTRAL", 3, 6, "TB_BaconUps_063", "Zoobot", "['BATTLECRY']", "MECHANICAL", "COMMON", 2, "<b>Battlecry:</b> Give a random friendly Beast, Dragon, and Murloc +2/+2.", "MINION");
	}
	else if (name == "Well Fed") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_063e", "Well Fed", "", "", "", -1, "+2/+2.", "ENCHANTMENT");
	}
	else if (name == "Coldlight Seer") {
		return BgBaseCard(4, "NEUTRAL", 3, 6, "TB_BaconUps_064", "Coldlight Seer", "['BATTLECRY']", "MURLOC", "RARE", 3, "<b>Battlecry:</b> Give your other Murlocs +4 Health.", "MINION");
	}
	else if (name == "Mrghlglhal") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_064e", "Mrghlglhal", "", "", "", -1, "+4 Health.", "ENCHANTMENT");
	}
	else if (name == "Metaltooth Leaper") {
		return BgBaseCard(6, "HUNTER", 3, 6, "TB_BaconUps_066", "Metaltooth Leaper", "['BATTLECRY']", "MECHANICAL", "RARE", 2, "<b>Battlecry:</b> Give your other Mechs +4 Attack.", "MINION");
	}
	else if (name == "Metal Teeth") {
		return BgBaseCard(-1, "HUNTER", -1, -1, "TB_BaconUps_066e", "Metal Teeth", "", "", "", -1, "+4 Attack.", "ENCHANTMENT");
	}
	else if (name == "Houndmaster") {
		return BgBaseCard(8, "HUNTER", 4, 6, "TB_BaconUps_068", "Houndmaster", "['BATTLECRY']", "", "FREE", 3, "<b>Battlecry:</b> Give a friendly Beast +4/+4 and <b>Taunt</b>.", "MINION");
	}
	else if (name == "Master's Presence") {
		return BgBaseCard(-1, "HUNTER", -1, -1, "TB_BaconUps_068e", "Master's Presence", "", "", "", -1, "+4/+4 and <b>Taunt</b>.", "ENCHANTMENT");
	}
	else if (name == "Screwjank Clunker") {
		return BgBaseCard(4, "WARRIOR", 4, 10, "TB_BaconUps_069", "Screwjank Clunker", "['BATTLECRY']", "MECHANICAL", "RARE", 3, "<b>Battlecry:</b> Give a friendly Mech +4/+4.", "MINION");
	}
	else if (name == "Screwy Jank") {
		return BgBaseCard(-1, "WARRIOR", -1, -1, "TB_BaconUps_069e", "Screwy Jank", "", "", "", -1, "+4/+4.", "ENCHANTMENT");
	}
	else if (name == "Crystalweaver") {
		return BgBaseCard(10, "WARLOCK", 4, 8, "TB_BaconUps_070", "Crystalweaver", "['BATTLECRY']", "", "COMMON", 3, "<b>Battlecry:</b> Give your Demons +2/+2.", "MINION");
	}
	else if (name == "Serrated Shadows") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_070e", "Serrated Shadows", "", "", "", -1, "+2/+2.", "ENCHANTMENT");
	}
	else if (name == "Strongshell Scavenger") {
		return BgBaseCard(4, "DRUID", 4, 6, "TB_BaconUps_072", "Strongshell Scavenger", "['BATTLECRY']", "", "RARE", 5, "<b>Battlecry:</b> Give your <b>Taunt</b> minions +4/+4.", "MINION");
	}
	else if (name == "Strongshell") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_072e", "Strongshell", "", "", "", -1, "+4/+4.", "ENCHANTMENT");
	}
	else if (name == "Menagerie Magician") {
		return BgBaseCard(8, "NEUTRAL", 5, 8, "TB_BaconUps_073", "Menagerie Magician", "['BATTLECRY']", "", "COMMON", 4, "<b>Battlecry:</b> Give a random friendly Beast, Dragon, and Murloc +4/+4.", "MINION");
	}
	else if (name == "A Simple Trick") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_073e", "A Simple Trick", "", "", "", -1, "+4/+4.", "ENCHANTMENT");
	}
	else if (name == "Virmen Sensei") {
		return BgBaseCard(8, "DRUID", 5, 10, "TB_BaconUps_074", "Virmen Sensei", "['BATTLECRY']", "", "RARE", 4, "<b>Battlecry:</b> Give a friendly Beast +4/+4.", "MINION");
	}
	else if (name == "Get Big") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_074e", "Get Big", "", "", "", -1, "+4/+4.", "ENCHANTMENT");
	}
	else if (name == "Soul Juggler") {
		return BgBaseCard(6, "WARLOCK", 3, 6, "TB_BaconUps_075", "Soul Juggler", "['TRIGGER_VISUAL']", "", "", 3, "After a friendly Demon dies, deal 3 damage to a random enemy minion twice.", "MINION");
	}
	else if (name == "Pogo-Hopper") {
		return BgBaseCard(2, "ROGUE", 1, 2, "TB_BaconUps_077", "Pogo-Hopper", "['BATTLECRY']", "MECHANICAL", "RARE", 2, "[x]<b>Battlecry:</b> Gain +4/+4 for each other Pogo-Hopper you played this game.", "MINION");
	}
	else if (name == "Kinetic Energy") {
		return BgBaseCard(-1, "ROGUE", -1, -1, "TB_BaconUps_077e", "Kinetic Energy", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Wrath Weaver") {
		return BgBaseCard(2, "NEUTRAL", 1, 2, "TB_BaconUps_079", "Wrath Weaver", "['TRIGGER_VISUAL']", "", "COMMON", 1, "After you play a Demon, deal 1 damage to your hero and gain +4/+4.", "MINION");
	}
	else if (name == "Wrath Woven") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_079e", "Wrath Woven", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Sneed's Old Shredder") {
		return BgBaseCard(10, "NEUTRAL", 8, 14, "TB_BaconUps_080", "Sneed's Old Shredder", "['DEATHRATTLE']", "MECHANICAL", "LEGENDARY", 5, "<b>Deathrattle:</b> Summon 2 random <b>Legendary</b> minions.", "MINION");
	}
	else if (name == "Lightfang Enforcer") {
		return BgBaseCard(4, "NEUTRAL", 6, 4, "TB_BaconUps_082", "Lightfang Enforcer", "['TRIGGER_VISUAL']", "", "EPIC", 5, "[x]At the end of your turn, give a friendly minion of each minion type +4/+2.", "MINION");
	}
	else if (name == "Blessed") {
		return BgBaseCard(-1, "ROGUE", -1, -1, "TB_BaconUps_082e", "Blessed", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Annihilan Battlemaster") {
		return BgBaseCard(6, "NEUTRAL", 8, 2, "TB_BaconUps_083", "Annihilan Battlemaster", "['BATTLECRY']", "DEMON", "EPIC", 5, "<b>Battlecry:</b> Gain +2 Health for each damage your hero has taken.", "MINION");
	}
	else if (name == "Gentle Megasaur") {
		return BgBaseCard(10, "NEUTRAL", 4, 8, "TB_BaconUps_084", "Gentle Megasaur", "['BATTLECRY']", "BEAST", "EPIC", 6, "<b>Battlecry:</b> <b>Adapt</b> your Murlocs twice.", "MINION");
	}
	else if (name == "Goldrinn, the Great Wolf") {
		return BgBaseCard(8, "NEUTRAL", 8, 8, "TB_BaconUps_085", "Goldrinn, the Great Wolf", "['DEATHRATTLE']", "BEAST", "LEGENDARY", 5, "<b>Deathrattle:</b> Give your Beasts +8/+8.", "MINION");
	}
	else if (name == "Soul of the Beast") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_085e", "Soul of the Beast", "", "", "", -1, "+8/+8.", "ENCHANTMENT");
	}
	else if (name == "Pack Leader") {
		return BgBaseCard(6, "NEUTRAL", 3, 6, "TB_BaconUps_086", "Pack Leader", "['TRIGGER_VISUAL']", "", "RARE", 3, "Whenever you summon a Beast, give it +6 Attack.", "MINION");
	}
	else if (name == "Feral Calling") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_086e", "Feral Calling", "", "", "", -1, "+6 Attack.", "ENCHANTMENT");
	}
	else if (name == "Kangor's Apprentice") {
		return BgBaseCard(6, "NEUTRAL", 9, 12, "TB_BaconUps_087", "Kangor's Apprentice", "['DEATHRATTLE']", "", "EPIC", 6, "<b>Deathrattle</b>: Summon the first 4 friendly Mechs that died this combat.", "MINION");
	}
	else if (name == "Dire Wolf Alpha") {
		return BgBaseCard(4, "NEUTRAL", 2, 4, "TB_BaconUps_088", "Dire Wolf Alpha", "['ADJACENT_BUFF', 'AURA']", "BEAST", "COMMON", 1, "Adjacent minions have +2 Attack.", "MINION");
	}
	else if (name == "Strength of the Pack") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_088e", "Strength of the Pack", "", "", "", -1, "+2 Attack from {0}.", "ENCHANTMENT");
	}
	else if (name == "Primalfin Lookout") {
		return BgBaseCard(6, "NEUTRAL", 3, 4, "TB_BaconUps_089", "Primalfin Lookout", "['BATTLECRY', 'DISCOVER']", "MURLOC", "COMMON", 5, "<b>Battlecry:</b> If you control another Murloc, <b>Discover</b> two Murlocs.", "MINION");
	}
	else if (name == "Mama Bear") {
		return BgBaseCard(10, "NEUTRAL", 8, 10, "TB_BaconUps_090", "Mama Bear", "['TRIGGER_VISUAL']", "BEAST", "EPIC", 6, "Whenever you summon a Beast, give it +10/+10.", "MINION");
	}
	else if (name == "Rampage") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_090e", "Rampage", "", "", "", -1, "+10/+10.", "ENCHANTMENT");
	}
	else if (name == "Zapp Slywick") {
		return BgBaseCard(14, "NEUTRAL", 8, 20, "TB_BaconUps_091", "Zapp Slywick", "['WINDFURY']", "", "", 6, "[x]<b>Mega-Windfury</b> This minion always attacks the enemy minion with the lowest Attack.", "MINION");
	}
	else if (name == "Alleycat") {
		return BgBaseCard(2, "HUNTER", 1, 2, "TB_BaconUps_093", "Alleycat", "['BATTLECRY']", "BEAST", "COMMON", 1, "<b>Battlecry:</b> Summon a 2/2 Cat.", "MINION");
	}
	else if (name == "Tabbycat") {
		return BgBaseCard(2, "HUNTER", 1, 2, "TB_BaconUps_093t", "Tabbycat", "", "BEAST", "", 1, "", "MINION");
	}
	else if (name == "Micro Machine") {
		return BgBaseCard(2, "NEUTRAL", 2, 4, "TB_BaconUps_094", "Micro Machine", "['TRIGGER_VISUAL']", "MECHANICAL", "COMMON", 1, "At the start of each turn, gain +2 Attack.", "MINION");
	}
	else if (name == "Pistons") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_094e", "Pistons", "", "", "", -1, "Increased Attack.", "ENCHANTMENT");
	}
	else if (name == "Shifter Zerus") {
		return BgBaseCard(2, "NEUTRAL", 1, 2, "TB_BaconUps_095", "Shifter Zerus", "", "", "LEGENDARY", 3, "Each turn this is in your hand, transform it into a random minion.", "MINION");
	}
	else if (name == "Shifting") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_095e", "Shifting", "", "", "", -1, "Transforming into random minions.", "ENCHANTMENT");
	}
	else if (name == "Annoy-o-Module") {
		return BgBaseCard(4, "PALADIN", 4, 8, "TB_BaconUps_099", "Annoy-o-Module", "['DIVINE_SHIELD', 'MODULAR', 'TAUNT']", "MECHANICAL", "RARE", 4, "<b>Magnetic</b> <b>Divine Shield</b> <b>Taunt</b>", "MINION");
	}
	else if (name == "Annoy-o-Module") {
		return BgBaseCard(-1, "PALADIN", -1, -1, "TB_BaconUps_099e", "Annoy-o-Module", "['MODULAR']", "", "", -1, "<b>Taunt</b>, <b>Divine Shield</b>.", "ENCHANTMENT");
	}
	else if (name == "King Bagurgle") {
		return BgBaseCard(12, "NEUTRAL", 6, 6, "TB_BaconUps_100", "King Bagurgle", "['BATTLECRY', 'DEATHRATTLE']", "MURLOC", "LEGENDARY", 5, "<b>Battlecry and Deathrattle:</b> Give your other Murlocs +4/+4.", "MINION");
	}
	else if (name == "Bagurgled") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_100e", "Bagurgled", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Floating Watcher") {
		return BgBaseCard(8, "WARLOCK", 5, 8, "TB_BaconUps_101", "Floating Watcher", "['TRIGGER_VISUAL']", "DEMON", "COMMON", 4, "Whenever your hero takes damage on your turn, gain +4/+4.", "MINION");
	}
	else if (name == "Brow Furrow") {
		return BgBaseCard(-1, "WARLOCK", -1, -1, "TB_BaconUps_101e", "Brow Furrow", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Red Whelp") {
		return BgBaseCard(2, "NEUTRAL", 1, 4, "TB_BaconUps_102", "Red Whelp", "['TRIGGER_VISUAL']", "DRAGON", "", 1, "[x]<b>Start of Combat:</b> Deal 1 damage per friendly Dragon to one random enemy minion twice.", "MINION");
	}
	else if (name == "Herald of Flame") {
		return BgBaseCard(10, "WARRIOR", 5, 12, "TB_BaconUps_103", "Herald of Flame", "['OVERKILL']", "DRAGON", "", 4, "<b>Overkill:</b> Deal 6 damage to the left-most enemy minion.", "MINION");
	}
	else if (name == "Hangry Dragon") {
		return BgBaseCard(8, "NEUTRAL", 5, 8, "TB_BaconUps_104", "Hangry Dragon", "['TRIGGER_VISUAL']", "DRAGON", "", 3, "[x]At the start of your turn, gain +4/+4 if you won the last combat.", "MINION");
	}
	else if (name == "Well Fed") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_104e", "Well Fed", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Waxrider Togwaggle") {
		return BgBaseCard(2, "NEUTRAL", 3, 4, "TB_BaconUps_105", "Waxrider Togwaggle", "['TRIGGER_VISUAL']", "", "", 2, "Whenever a friendly Dragon kills an enemy, gain +4/+4.", "MINION");
	}
	else if (name == "Dragon Wax") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_105e", "Dragon Wax", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Razorgore, the Untamed") {
		return BgBaseCard(4, "NEUTRAL", 8, 8, "TB_BaconUps_106", "Razorgore, the Untamed", "['TRIGGER_VISUAL']", "DRAGON", "", 5, "At the end of your turn, gain +2/+2 for each Dragon you have.", "MINION");
	}
	else if (name == "Dragonlust") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_106e", "Dragonlust", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Steward of Time") {
		return BgBaseCard(6, "NEUTRAL", 4, 8, "TB_BaconUps_107", "Steward of Time", "", "DRAGON", "", 2, "When you sell this minion, give all minions in Bob's Tavern +2/+2.", "MINION");
	}
	else if (name == "Time Dilation") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_107e", "Time Dilation", "", "", "", -1, "+2/+2.", "ENCHANTMENT");
	}
	else if (name == "Twilight Emissary") {
		return BgBaseCard(8, "NEUTRAL", 6, 8, "TB_BaconUps_108", "Twilight Emissary", "['BATTLECRY', 'TAUNT']", "DRAGON", "", 3, "<b>Taunt</b> <b>Battlecry:</b> Give a friendly Dragon +4/+4.", "MINION");
	}
	else if (name == "Twilight Embrace") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_108e", "Twilight Embrace", "", "", "", -1, "+4/+4.", "ENCHANTMENT");
	}
	else if (name == "Kalecgos, Arcane Aspect") {
		return BgBaseCard(8, "NEUTRAL", 8, 24, "TB_BaconUps_109", "Kalecgos, Arcane Aspect", "['TRIGGER_VISUAL']", "DRAGON", "", 6, "After you play a minion with <b>Battlecry</b>, give your Dragons +2/+2.", "MINION");
	}
	else if (name == "Arcane Aspect") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_109e", "Arcane Aspect", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Murozond") {
		return BgBaseCard(10, "NEUTRAL", 7, 10, "TB_BaconUps_110", "Murozond", "['BATTLECRY']", "DRAGON", "", 5, "[x]<b>Battlecry:</b> Add a minion from your last opponent's warband to your hand. Make it Golden!", "MINION");
	}
	else if (name == "Fiendish Servant") {
		return BgBaseCard(4, "WARLOCK", 1, 2, "TB_BaconUps_112", "Fiendish Servant", "['DEATHRATTLE']", "DEMON", "COMMON", 1, "[x]<b>Deathrattle:</b> Give this minion's Attack to a random friendly minion twice.", "MINION");
	}
	else if (name == "Imprisoner") {
		return BgBaseCard(6, "NEUTRAL", 3, 6, "TB_BaconUps_113", "Imprisoner", "['DEATHRATTLE', 'TAUNT']", "DEMON", "RARE", 2, "<b>Taunt</b> <b>Deathrattle:</b> Summon a 2/2 Imp.", "MINION");
	}
	else if (name == "Glyph Guardian") {
		return BgBaseCard(4, "MAGE", 3, 8, "TB_BaconUps_115", "Glyph Guardian", "['TRIGGER_VISUAL']", "DRAGON", "", 2, "Whenever this attacks, triple its Attack.", "MINION");
	}
	else if (name == "Cold Breath") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_115e", "Cold Breath", "", "", "", -1, "Multiplying Attack.", "ENCHANTMENT");
	}
	else if (name == "Imp Mama") {
		return BgBaseCard(12, "WARLOCK", 8, 20, "TB_BaconUps_116", "Imp Mama", "['TRIGGER_VISUAL']", "DEMON", "", 6, "[x]Whenever this minion takes damage, summon 2 random Demons and give them <b>Taunt</b>.", "MINION");
	}
	else if (name == "Drakonid Enforcer") {
		return BgBaseCard(6, "NEUTRAL", 6, 12, "TB_BaconUps_117", "Drakonid Enforcer", "['TRIGGER_VISUAL']", "DRAGON", "", 4, "After a friendly minion loses <b>Divine Shield</b>, gain +4/+4.", "MINION");
	}
	else if (name == "Divinity") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_117e", "Divinity", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Unstable Ghoul") {
		return BgBaseCard(2, "NEUTRAL", 2, 6, "TB_BaconUps_118", "Unstable Ghoul", "['DEATHRATTLE', 'TAUNT']", "", "COMMON", 2, "<b>Taunt</b> <b>Deathrattle:</b> Deal 1 damage to all minions twice.", "MINION");
	}
	else if (name == "Master Demonologist") {
		return BgBaseCard(8, "NEUTRAL", 7, 12, "TB_BaconUps_119", "Master Demonologist", "['TRIGGER_VISUAL']", "DEMON", "", -1, "Whenever you summon a Demon, gain +2/+2.", "MINION");
	}
	else if (name == "Demonic Fury") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_119e", "Demonic Fury", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Cobalt Scalebane") {
		return BgBaseCard(10, "NEUTRAL", 5, 10, "TB_BaconUps_120", "Cobalt Scalebane", "['TRIGGER_VISUAL']", "DRAGON", "COMMON", 4, "At the end of your turn, give another random friendly minion +6 Attack.", "MINION");
	}
	else if (name == "Dragonscales") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_120e", "Dragonscales", "", "", "", -1, "Attack increased.", "ENCHANTMENT");
	}
	else if (name == "Deflect-o-Bot") {
		return BgBaseCard(6, "NEUTRAL", 4, 4, "TB_BaconUps_123", "Deflect-o-Bot", "['TRIGGER_VISUAL']", "MECHANICAL", "", 3, "[x]<b>Divine Shield</b> Whenever you summon a Mech during combat, gain +2 Attack and <b>Divine Shield</b>.", "MINION");
	}
	else if (name == "Deflect-o-Shield") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_123e", "Deflect-o-Shield", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Felfin Navigator") {
		return BgBaseCard(8, "NEUTRAL", 4, 8, "TB_BaconUps_124", "Felfin Navigator", "['BATTLECRY']", "MURLOC", "COMMON", 3, "<b>Battlecry:</b> Give your other Murlocs +2/+2.", "MINION");
	}
	else if (name == "Felfin Fueled") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_124e", "Felfin Fueled", "", "", "", -1, "+2/+2.", "ENCHANTMENT");
	}
	else if (name == "Rabid Saurolisk") {
		return BgBaseCard(6, "HUNTER", 3, 4, "TB_BaconUps_125", "Rabid Saurolisk", "['TRIGGER_VISUAL']", "BEAST", "", 2, "After you play a minion with <b>Deathrattle</b>, gain +2/+2.", "MINION");
	}
	else if (name == "Rabid") {
		return BgBaseCard(-1, "HUNTER", -1, -1, "TB_BaconUps_125e", "Rabid", "", "", "", -1, "+2/+2.", "ENCHANTMENT");
	}
	else if (name == "Deck Swabbie") {
		return BgBaseCard(4, "NEUTRAL", 3, 4, "TB_BaconUps_126", "Deck Swabbie", "['BATTLECRY']", "PIRATE", "", 1, "<b>Battlecry:</b> Reduce the cost of upgrading Bob's Tavern by (2).", "MINION");
	}
	else if (name == "Freedealing Gambler") {
		return BgBaseCard(6, "NEUTRAL", 3, 6, "TB_BaconUps_127", "Freedealing Gambler", "", "PIRATE", "", 2, "This minion sells for 6 Gold.", "MINION");
	}
	else if (name == "Arcane Cannon") {
		return BgBaseCard(4, "NEUTRAL", 3, 4, "TB_BaconUps_128", "Arcane Cannon", "['CANT_ATTACK', 'TRIGGER_VISUAL']", "", "", 2, "[x]Can't attack. After an adjacent minion attacks, deal 2 damage to    an enemy minion twice.", "MINION");
	}
	else if (name == "Goldgrubber") {
		return BgBaseCard(4, "NEUTRAL", 5, 4, "TB_BaconUps_130", "Goldgrubber", "['TRIGGER_VISUAL']", "PIRATE", "", 4, "At the end of your turn, gain +4/+4 for each friendly Golden minion.", "MINION");
	}
	else if (name == "Gold Grubbing") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_130e", "Gold Grubbing", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Nat Pagle, Extreme Angler") {
		return BgBaseCard(16, "NEUTRAL", 7, 10, "TB_BaconUps_132", "Nat Pagle, Extreme Angler", "", "PIRATE", "", 5, "<b>Overkill:</b> Summon a 0/2 Golden Treasure Chest.", "MINION");
	}
	else if (name == "Treasure Chest") {
		return BgBaseCard(0, "NEUTRAL", 2, 2, "TB_BaconUps_132t", "Treasure Chest", "", "", "", 1, "<b>Deathrattle:</b> Summon 2 random Golden minions.", "MINION");
	}
	else if (name == "Cap'n Hoggarr") {
		return BgBaseCard(12, "NEUTRAL", 6, 12, "TB_BaconUps_133", "Cap'n Hoggarr", "['TRIGGER_VISUAL']", "PIRATE", "", 5, "After you buy a Pirate, gain 2 Gold this turn only.", "MINION");
	}
	else if (name == "Dread Admiral Eliza") {
		return BgBaseCard(12, "NEUTRAL", 6, 14, "TB_BaconUps_134", "Dread Admiral Eliza", "['TRIGGER_VISUAL']", "PIRATE", "", 6, "Whenever a friendly Pirate attacks, give all friendly minions +2/+2.", "MINION");
	}
	else if (name == "Yaharr!!") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_134e", "Yaharr!!", "", "", "", -1, "+2/+2.", "ENCHANTMENT");
	}
	else if (name == "Monstrous Macaw") {
		return BgBaseCard(6, "NEUTRAL", 3, 4, "TB_BaconUps_135", "Monstrous Macaw", "['TRIGGER_VISUAL']", "BEAST", "", 3, "[x]After this attacks, trigger a random friendly minion's <b>Deathrattle</b> twice.", "MINION");
	}
	else if (name == "Southsea Captain") {
		return BgBaseCard(6, "NEUTRAL", 3, 6, "TB_BaconUps_136", "Southsea Captain", "['AURA']", "PIRATE", "EPIC", 2, "Your other Pirates have +2/+2.", "MINION");
	}
	else if (name == "Yarrr!") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_136e", "Yarrr!", "", "", "", -1, "Southsea Captain is granting +2/+2.", "ENCHANTMENT");
	}
	else if (name == "The Tide Razor") {
		return BgBaseCard(12, "NEUTRAL", 7, 8, "TB_BaconUps_137", "The Tide Razor", "['DEATHRATTLE']", "", "", 6, "<b>Deathrattle</b>: Summon 6 random Pirates.", "MINION");
	}
	else if (name == "Bloodsail Cannoneer") {
		return BgBaseCard(8, "NEUTRAL", 4, 4, "TB_BaconUps_138", "Bloodsail Cannoneer", "", "PIRATE", "", 3, "<b>Battlecry</b>: Give your other Pirates +6 Attack.", "MINION");
	}
	else if (name == "Pirate Life!") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_138e", "Pirate Life!", "", "", "", -1, "+6 Attack.", "ENCHANTMENT");
	}
	else if (name == "Ripsnarl Captain") {
		return BgBaseCard(6, "NEUTRAL", 4, 8, "TB_BaconUps_139", "Ripsnarl Captain", "['TRIGGER_VISUAL']", "PIRATE", "", 4, "Whenever another friendly Pirate attacks, give it +4/+4.", "MINION");
	}
	else if (name == "Snarled") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_139e", "Snarled", "", "", "", -1, "+4/+4.", "ENCHANTMENT");
	}
	else if (name == "Southsea Strongarm") {
		return BgBaseCard(10, "NEUTRAL", 5, 8, "TB_BaconUps_140", "Southsea Strongarm", "", "PIRATE", "", 4, "<b>Battlecry:</b> Give a friendly Pirate +2/+2 for each Pirate you bought this turn.", "MINION");
	}
	else if (name == "Pirate Tattoos") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_140e", "Pirate Tattoos", "", "", "", -1, "Increased stats.", "ENCHANTMENT");
	}
	else if (name == "Scallywag") {
		return BgBaseCard(4, "NEUTRAL", 1, 2, "TB_BaconUps_141", "Scallywag", "['DEATHRATTLE']", "PIRATE", "", 1, "<b>Deathrattle:</b> Summon a 2/2 Pirate. It attacks immediately.", "MINION");
	}
	else if (name == "Sky Pirate") {
		return BgBaseCard(2, "ROGUE", 1, 2, "TB_BaconUps_141t", "Sky Pirate", "", "PIRATE", "", 1, "", "MINION");
	}
	else if (name == "Seabreaker Goliath") {
		return BgBaseCard(12, "NEUTRAL", 7, 14, "TB_BaconUps_142", "Seabreaker Goliath", "['OVERKILL']", "PIRATE", "", 5, "<b>Windfury</b> <b>Overkill:</b> Give your other Pirates +4/+4.", "MINION");
	}
	else if (name == "Broken Seas") {
		return BgBaseCard(-1, "NEUTRAL", -1, -1, "TB_BaconUps_142e", "Broken Seas", "", "", "", -1, "+4/+4.", "ENCHANTMENT");
	}
	else if (name == "Salty Looter") {
		return BgBaseCard(6, "ROGUE", 4, 6, "TB_BaconUps_143", "Salty Looter", "['TRIGGER_VISUAL']", "PIRATE", "", 3, "Whenever you play a Pirate, gain +2/+2.", "MINION");
	}
	else if (name == "Loot!") {
